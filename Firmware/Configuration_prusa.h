...
#define NOZZLE_TYPE "Hemera V6"

// Developer flag
#define DEVELOPER

// Printer name
#define CUSTOM_MENDEL_NAME "Hemera i3 Mk2"
...
#define X_PROBE_OFFSET_FROM_EXTRUDER 47     // Z probe to nozzle X offset: -left  +right , 23 originally
#define Y_PROBE_OFFSET_FROM_EXTRUDER 22     // Z probe to nozzle Y offset: -front +behind , 9 originally
