...
#define BED_ZERO_REF_X (- 23.5f + X_PROBE_OFFSET_FROM_EXTRUDER)
#define BED_ZERO_REF_Y (-  1.2f + Y_PROBE_OFFSET_FROM_EXTRUDER)
...
const float bed_ref_points[] PROGMEM = {
    13.f  - BED_ZERO_REF_X,    6.4f - BED_ZERO_REF_Y, // 13.f - BED_ZERO_REF_X,   6.4f - BED_ZERO_REF_Y,
    115.f - BED_ZERO_REF_X,    6.4f - BED_ZERO_REF_Y, // 115.f - BED_ZERO_REF_X,   6.4f - BED_ZERO_REF_Y,
    216.f - BED_ZERO_REF_X,    6.4f - BED_ZERO_REF_Y, // 216.f - BED_ZERO_REF_X,   6.4f - BED_ZERO_REF_Y,

    216.f - BED_ZERO_REF_X,  104.4f - BED_ZERO_REF_Y, // 216.f - BED_ZERO_REF_X, 104.4f - BED_ZERO_REF_Y,
    115.f - BED_ZERO_REF_X,  104.4f - BED_ZERO_REF_Y, // 115.f - BED_ZERO_REF_X, 104.4f - BED_ZERO_REF_Y,
    13.f  - BED_ZERO_REF_X,  104.4f - BED_ZERO_REF_Y, // 13.f  - BED_ZERO_REF_X, 104.4f - BED_ZERO_REF_Y,

    13.f  - BED_ZERO_REF_X,  202.4f - BED_ZERO_REF_Y, // 13.f  - BED_ZERO_REF_X, 202.4f - BED_ZERO_REF_Y,
    115.f - BED_ZERO_REF_X,  202.4f - BED_ZERO_REF_Y, // 115.f - BED_ZERO_REF_X, 202.4f - BED_ZERO_REF_Y,
    216.f - BED_ZERO_REF_X,  202.4f - BED_ZERO_REF_Y  // 216.f - BED_ZERO_REF_X, 202.4f - BED_ZERO_REF_Y
};
